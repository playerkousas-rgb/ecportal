...
import { constitution, articleCount, profile, settings, memberName } from '../lib/model.js';
...
function docBody(c, editing) {
  ...
  <div class="xs faint mt-8">版本 v${esc(c.version || '—')} · 更新日期 ${esc(c.updated || '')} · 由執委管理系統輸出</div>`;
}
